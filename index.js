...
client.on("message", async message => {
  ...
  if (message.content.match(prefixMention)) {
    ...
    let embed = new MessageEmbed()
        ...
        .setDescription(`Hey **${message.author.username},** It's me ${client.user.username}. Here are some of my config: 
        ...
        ${dev} **Developer** [greatnazizombie \[Team925\]#0470](https://discord.gg/gU7XAxTpX5)
        `)
        .setColor("#EFB9BE")
